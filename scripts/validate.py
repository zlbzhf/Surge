...
def check_bsbsb_module() -> list[Issue]:
    ...
    module_checks = [
        ...
        ("bilibili-bsbsb.airborne.js?v=20260523-summary-playback-start-1", "module should cache-bust the airborne script URL after changing summary danmaku playback-start timing so Surge does not run stale code"),
