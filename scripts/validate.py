...
def check_bsbsb_module() -> list[Issue]:
    ...
    module_checks = [
        ...
        ("bilibili-bsbsb.airborne.js?v=20260523-disable-commanddm-exp-1", "module should cache-bust the airborne script URL after disabling the DmView CommandDm injection experiment so Surge does not run stale code"),
