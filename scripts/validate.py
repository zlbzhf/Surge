...
def check_bsbsb_module() -> list[Issue]:
    ...
    module_checks = [
        ...
        ("bilibili-bsbsb.airborne.js?v=20260523-commanddm-exp-1", "module should cache-bust the airborne script URL after adding the opt-in CommandDm experiment so Surge does not run stale code"),
        ...
        ('"commandDmExperiment":"{{{CommandDm实验}}}"', "response hook should pass the opt-in CommandDm experiment flag to the script"),
        ...
        ("UI观测:0", "Bilibili UI/card metadata observation should stay opt-in and disabled by default"),
        ("CommandDm实验:0", "CommandDm native-card rendering experiment should stay opt-in and disabled by default"),
    ...
    script_checks = [
        ...
        ("injectExperimentalCommandDm", "script should support an opt-in smallest-possible DmView CommandDm injection experiment"),
        ("#ATTENTION#", "CommandDm experiment should use the observed attention command shape instead of inventing an unknown command"),
    ...
    doc_checks = [
        ...
        ("CommandDm实验", "docs should document the opt-in DmView command_dms injection experiment"),
