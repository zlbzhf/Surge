...
def check_bsbsb_module() -> list[Issue]:
    ...
    module_checks = [
        ...
        ("bilibili-bsbsb.airborne.js?v=20260523-ui-observe-1", "module should cache-bust the airborne script URL after adding DmView/ViewProgress UI observation so Surge does not run stale code"),
